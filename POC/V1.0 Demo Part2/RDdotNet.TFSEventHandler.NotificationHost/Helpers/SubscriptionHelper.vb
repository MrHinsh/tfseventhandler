...
Namespace Helpers
    ...
    Public Class SubscriptionHelper
        ...
        Public Shared Sub Subscribe()
            SubscribeEvent(tfsServer, "TFSEventHandler", "http://localhost:65469/v1.0/Notification.svc/WorkItemChanged", DeliveryType.Soap, Schedule.Imediate, EventType.WorkItemChangedEvent)
        End Sub
