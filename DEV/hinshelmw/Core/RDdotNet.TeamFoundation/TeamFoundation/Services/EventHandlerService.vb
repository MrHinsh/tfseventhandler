...
#Region " Bits "
        ...
        Private Function GetObject(Of T As {New})(ByVal XmlFile As XmlFiles) As T
            ...
            Dim x As New Helpers.CustomXmlSerializer()
            SyncLock x
                GetObject = New T
...
#End Region
        ...
        Public Function GetAssemblyItem(ByVal AssemblyBytes As Byte()) As AssemblyItem Implements Contracts.IHandlers.GetAssemblyItem
            Try
                ...
                AssemblyItem = Helpers.AssemblyHelper.GetAssemblyItem(Config.SettingsSection.Instance.Repository.LocalPath, AssemblyBytes)
                Return AssemblyItem
