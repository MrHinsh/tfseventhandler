...
Namespace UI.FormControls.Tree
    ...
    Public MustInherit Class TreeNodeCustom(Of T As {TreeNode})
        ...
        Public ReadOnly Property EventHandler() As Servers.TFSEventHandlerServer
            Get
        ...
        Public Sub New(ByVal NodeName As String, ByVal EventHandler As Servers.TFSEventHandlerServer, Optional ByVal Delay As Integer = 0)
